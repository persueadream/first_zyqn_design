...
#
# Generated by export_simulation on Thu Aug 31 21:09:36 +0800 2017
#
################################################################################
...
switch to the './zynq_system_1.sh' script.

./zynq_system_1.sh -reset_run
...
./zynq_system_1.sh -noclean_files

For more information on the script, please type './zynq_system_1.sh -help'.

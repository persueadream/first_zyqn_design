...
#
# Generated by Vivado on Thu Aug 31 21:09:36 +0800 2017
# IP Build 1412160 on Tue Nov 17 13:47:24 MST 2015 
#
# usage: zynq_system_1.sh [-help]
# usage: zynq_system_1.sh [-lib_map_path]
# usage: zynq_system_1.sh [-noclean_files]
# usage: zynq_system_1.sh [-reset_run]
#
...
# executing this script. Please type 'zynq_system_1.sh -help' for more information.
#
...
# Script info
echo -e "zynq_system_1.sh - Script generated by export_simulation (Vivado v2015.4 (64-bit)-id)\n"

# Script usage
usage()
{
  msg="Usage: zynq_system_1.sh [-help]\n\
Usage: zynq_system_1.sh [-lib_map_path]\n\
Usage: zynq_system_1.sh [-reset_run]\n\
Usage: zynq_system_1.sh [-noclean_files]\n\n\
...
if [[ ($# == 1 ) && ($1 != "-lib_map_path" && $1 != "-noclean_files" && $1 != "-reset_run" && $1 != "-help" && $1 != "-h") ]]; then
  echo -e "ERROR: Unknown option specified '$1' (type \"./zynq_system_1.sh -help\" for more information)\n"
  exit 1
fi
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./zynq_system_1.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key zynq_system_1_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc zynq_system_1_simv.daidir)
...
compile()
{
  ...
  vlogan -work xil_defaultlib $opts_ver +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    ...
    "$ref_dir/../../../bd/zynq_system_1/ip/zynq_system_1_processing_system7_0_0/sim/zynq_system_1_processing_system7_0_0.v" \
  ...
  vhdlan -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/zynq_system_1/ip/zynq_system_1_axi_gpio_0_0/sim/zynq_system_1_axi_gpio_0_0.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vhdlan -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/zynq_system_1/ip/zynq_system_1_rst_processing_system7_0_100M_0/sim/zynq_system_1_rst_processing_system7_0_100M_0.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vlogan -work xil_defaultlib $opts_ver +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/zynq_system_1/ip/zynq_system_1_auto_pc_0/sim/zynq_system_1_auto_pc_0.v" \
    "$ref_dir/../../../bd/zynq_system_1/hdl/zynq_system_1.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.zynq_system_1 xil_defaultlib.glbl -o zynq_system_1_simv
}
...
simulate()
{
  ...
  ./zynq_system_1_simv $opts -do simulate.do
}
# Script usage
usage()
{

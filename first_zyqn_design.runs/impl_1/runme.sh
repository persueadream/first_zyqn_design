...
HD_PWD='G:/Embedded/ZYNQ7000/Program/Zed/first_zyqn_design/first_zyqn_design.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_system_1_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source zynq_system_1_wrapper.tcl -notrace

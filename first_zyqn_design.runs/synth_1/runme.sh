...
HD_PWD='G:/Embedded/ZYNQ7000/Program/Zed/first_zyqn_design/first_zyqn_design.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_system_1_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source zynq_system_1_wrapper.tcl
